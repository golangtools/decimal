...
func (d *Decimal) Add(from *Decimal) *Decimal {
	ret := new(Decimal)
	err := DecimalAdd(d, from, ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) Sub(from *Decimal) *Decimal {
	ret := new(Decimal)
	err := DecimalSub(d, from, ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) Mul(from *Decimal) *Decimal {
	ret := new(Decimal)
	err := DecimalMul(d, from, ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) Div(from *Decimal, fracIncr ...int) *Decimal {
	fi := 0
	if len(fracIncr) > 0 {
		fi = fracIncr[0]
	}
...
func (d *Decimal) Mod(from *Decimal) *Decimal {
	ret := new(Decimal)
	err := DecimalMod(d, from, ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) AddInt(from int64) *Decimal {
	ret := new(Decimal)
	err := DecimalAdd(d, NewDecFromInt(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) SubInt(from int64) *Decimal {
	ret := new(Decimal)
	err := DecimalSub(d, NewDecFromInt(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) MulInt(from int64) *Decimal {
	ret := new(Decimal)
	err := DecimalMul(d, NewDecFromInt(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) DivInt(from int64, fracIncr ...int) *Decimal {
	fi := 0
	if len(fracIncr) > 0 {
		fi = fracIncr[0]
	}
...
func (d *Decimal) ModInt(from int64) *Decimal {
	ret := new(Decimal)
	err := DecimalMod(d, NewDecFromInt(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) AddFloat(from float64) *Decimal {
	ret := new(Decimal)
	err := DecimalAdd(d, NewDecFromFloat(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) SubFloat(from float64) *Decimal {
	ret := new(Decimal)
	err := DecimalSub(d, NewDecFromFloat(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) MulFloat(from float64) *Decimal {
	ret := new(Decimal)
	err := DecimalMul(d, NewDecFromFloat(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) DivFloat(from float64, fracIncr ...int) *Decimal {
	fi := 0
	if len(fracIncr) > 0 {
		fi = fracIncr[0]
	}
...
func (d *Decimal) ModFloat(from float64) *Decimal {
	ret := new(Decimal)
	err := DecimalMod(d, NewDecFromFloat(from), ret)
	if err != nil {
		panic(err)
	}
	return ret
...
func (d *Decimal) SubString(from string) (*Decimal, error) {
	dm, err := NewDecFromString(from)
	if err != nil {
		return nil, err
	}
	ret := new(Decimal)
	err = DecimalSub(d, dm, ret)
	if err != nil {
		return nil, err
	}
	return ret, nil
...
func (d *Decimal) MulString(from string) (*Decimal, error) {
	dm, err := NewDecFromString(from)
	if err != nil {
		return nil, err
	}
	ret := new(Decimal)
	err = DecimalMul(d, dm, ret)
	if err != nil {
		return nil, err
	}
	return ret, nil
...
func (d *Decimal) DivString(from string, fracIncr ...int) (*Decimal, error) {
	fi := 0
	if len(fracIncr) > 0 {
		fi = fracIncr[0]
	}
...
func (d *Decimal) ModString(from string) (*Decimal, error) {
	dm, err := NewDecFromString(from)
	if err != nil {
		return nil, err
	}
	ret := new(Decimal)
	err = DecimalMod(d, dm, ret)
	if err != nil {
		return nil, err
	}
	return ret, nil
...
func (d *Decimal) Equal(to *Decimal) bool {
	return d.Compare(to) == 0
}

func (d *Decimal) Greater(to *Decimal) bool {
	return d.Compare(to) > 0
}

func (d *Decimal) Less(to *Decimal) bool {
	return d.Compare(to) < 0
}

func (d *Decimal) GreaterOrEqual(to *Decimal) bool {
	return d.Compare(to) >= 0
}
