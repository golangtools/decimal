...
var td = Suite(&testDecimalSuite{})

func TestDecimal(testingT *testing.T) {
	output := os.Stdout
...
func (s *testDecimalSuite) TestFromInt(c *C) {
	tests := []struct {
		input  int64
		output string
	}{
...
func (s *testDecimalSuite) TestFromUint(c *C) {
	tests := []struct {
		input  uint64
		output string
	}{
...
func (s *testDecimalSuite) TestToInt(c *C) {
	tests := []struct {
		input  string
		output int64
		err    error
...
func (s *testDecimalSuite) TestToUint(c *C) {
	tests := []struct {
		input  string
		output uint64
		err    error
...
func (s *testDecimalSuite) TestFromFloat(c *C) {
	tests := []struct {
		s string
		f float64
	}{
	...
	for _, tt := range tests {
		dec := NewDecFromFloat(tt.f)
		str := dec.ToString()
		c.Check(string(str), Equals, tt.s)
	}
}

func (s *testDecimalSuite) TestToFloat(c *C) {
	tests := []struct {
		s string
		f float64
	}{
...
func (s *testDecimalSuite) TestShift(c *C) {
	type tcase struct {
		input  string
		shift  int
		output string
...
func (s *testDecimalSuite) TestRoundWithHalfEven(c *C) {
	tests := []struct {
		input  string
		scale  int
		output string
...
func (s *testDecimalSuite) TestRoundWithTruncate(c *C) {
	tests := []struct {
		input  string
		scale  int
		output string
...
func (s *testDecimalSuite) TestRoundWithCeil(c *C) {
	tests := []struct {
		input  string
		scale  int
		output string
...
func (s *testDecimalSuite) TestFromString(c *C) {
	type tcase struct {
		input  string
		output string
		err    error
...
func (s *testDecimalSuite) TestToString(c *C) {
	type tcase struct {
		input  string
		output string
	}
...
func (s *testDecimalSuite) TestToBinFromBin(c *C) {
	type tcase struct {
		input     string
		precision int
		frac      int
	...
	for _, tt := range errTests {
		...
		c.Assert(ErrBadNumber == err, IsTrue)
	}
}

func (s *testDecimalSuite) TestCompare(c *C) {
	type tcase struct {
		a   string
		b   string
		cmp int
...
func (s *testDecimalSuite) TestMaxDecimal(c *C) {
	type tcase struct {
		prec   int
		frac   int
		result string
...
func (s *testDecimalSuite) TestAdd(c *C) {
	...
	for _, tt := range tests {
		a := NewDecFromStringMust(tt.a)
		b := NewDecFromStringMust(tt.b)
		var sum Decimal
...
func (s *testDecimalSuite) TestSub(c *C) {
	type tcase struct {
		a      string
		b      string
		result string
...
func (s *testDecimalSuite) TestMul(c *C) {
	type tcase struct {
		a      string
		b      string
		result string
...
func (s *testDecimalSuite) TestDivMod(c *C) {
	type tcase struct {
		a      string
		b      string
		result string
...
func (s *testDecimalSuite) TestMaxOrMin(c *C) {
	type tcase struct {
		neg    bool
		prec   int
		frac   int
